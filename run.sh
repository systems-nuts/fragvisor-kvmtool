...
function compile_guest_kernel {
	...
	ssh $THISNODE make -j32 -C $KERNEL_PATH/ > stdout
...
######
# Jack: The tap0 can only be created after the lkvm starts. 
#	So do sleep 120 && sudo brctl addif br0 tap0 & in the background is very important!!!
#
...
#sleep 180 && echo "sudo brctl addif br0 tap0" && sudo brctl addif br0 tap0 && echo "brctl show" &
ret=`brctl show |wc -l`
echo "brctl show |wc -l ret=$ret"
while [[ $ret == 3 ]]; do # this is not for creating tap0 but prevent from something else
...
#04/06/2021  RAMDISK TO USE FOR SOSP
...
#Jack ++ mq=4
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 32768 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page -no-kvm-pit-reinjection clocksource=tsc\" --network mode=tap,vhost=1,mq=4,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"

#2vCPU/ 2 nodes
#sudo bash -c "./lkvm run -a 1 -b 1 -w 2 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 32768 -c 2 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=2 percpu_alloc=page -no-kvm-pit-reinjection clocksource=tsc\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
...
# jack adds -no-kvm-pit-reinjection clocksource=tsc RAMDISK TO USE FOR SOSP
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_lemp_4php.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 20480 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page -no-kvm-pit-reinjection clocksource=tsc\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"

#2vCPU/2 Nodes
#sudo bash -c "./lkvm run -a 1 -b 1 -w 2 -i $USER/c/ramdisk_lemp_2php.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 20480 -c 2 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=2 percpu_alloc=page -no-kvm-pit-reinjection clocksource=tsc\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
...
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 14336 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_lemp_4php.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 34336 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page\" --network mode=tap,vhost=1,mq=4,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"

#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_lemp_2php.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 34336 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"

#testing220417
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -w 3 -i $USER/c/ramdisk_lemp_3php.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 14336 -c 3 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=3 percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
#testing220417 vcpu1 migration back works!
#sudo bash -c "./lkvm run -a 1 -b 1 -w 2 -i $USER/c/ramdisk_lemp_2php.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 14336 -c 2 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=2 percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"

#####EUROSYS 23########################TONG TRY TO SAVE THE WORD
#sudo bash -c "./lkvm run -a 2 -b 2 -x 2 -y 2 -w 8 -i $USER/c/ramdisk_lemp_4php.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 19336 -c 8 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=8 percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
###############################################################
...
#04/05/2021 RAMDISK TO USE FOR SOSP
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_for_openlambda200625.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 32768 -c 4 -p \"root=/dev/ram rw fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page -no-kvm-pit-reinjection clocksource=tsc\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"

#3vCPU SOSP
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -w 3 -i $USER/c/ramdisk_for_openlambda200625.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 32768 -c 3 -p \"root=/dev/ram rw fstype=ext4 spectre_v2=off nopti pti=off numa=fake=3 percpu_alloc=page -no-kvm-pit-reinjection clocksource=tsc\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"

#2 vCPUs / 2 Nodes
#sudo bash -c "./lkvm run -a 1 -b 1 -w 2 -i $USER/c/ramdisk_for_openlambda200625.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 32768 -c 2 -p \"root=/dev/ram rw fstype=ext4 spectre_v2=off nopti pti=off numa=fake=2 percpu_alloc=page -no-kvm-pit-reinjection clocksource=tsc\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
...
# testing migration (O)
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 14336 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
# testing migration, add ram(?) # 16384 # 18432
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 18432 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
# don't boot kernel
#sudo bash -c "./lkvm run -a 1 -b 1 -w 2 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 14336 -c 2 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
# NO OPTIMIZATION: remove numa and percpu_alloc (debug.h 2 off) is&ft too long others good
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 18432 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
# put only percpu_alloc back (better but still ft (is?) high )
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 18432 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
# put only numa bac aka only remove percpu=page
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 18432 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
## new -no-kvm-pit-reinjection clocksource=tsc
# TODO NO OPTIMIZATION: remove percpu=page add clocksource=tsc + guest2off # TODO put clocksource=tsc to make it worse? 0517last for no optimization
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 14336 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 clocksource=tsc\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
# TODO NO OPTIMIZATION for NPB - remove numa=4 # this *looks* it makes more sense for no opt 0517
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 18432 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off clocksource=tsc\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
#
# OPTIMIZATION ALL ON: add -no-kvm-pit-reinjection numa per_cpu guest2on
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 18432 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page -no-kvm-pit-reinjection clocksource=tsc\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
# (O) PARSEC OPTOMIZATION (tsc or no pit make sloew?) remove tsc
...
# Note: no maater has clocksource=tsc, root@(none):/# cat /sys/devices/system/clocksource/clocksource0/current_clocksource = kvm-clock


# OPTIMIZATION: w/ numa & percpu_alloc (debug.h 2 on)
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 18432 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"

##FOR KARIM#### Last check220416 was on this: 
#sudo bash -c "./lkvm run -a 1 -b 1 -x 1 -y 1 -w 4 -i $USER/c/ramdisk_NPB_ATC.gz -k $KERNEL_PATH/arch/x86/boot/bzImage -m 32768 -c 4 -p \"root=/dev/ram rw init=/init2 fstype=ext4 spectre_v2=off nopti pti=off numa=fake=4 percpu_alloc=page\" --network mode=tap,vhost=1,guest_ip=10.4.4.222,host_ip=10.4.4.221,guest_mac=00:11:22:33:44:55"
