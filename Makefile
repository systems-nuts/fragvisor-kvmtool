...
POPCORN_LIB_PATH = /home/jackchuang/share/popcorn-kernel-lib/lib
POPCORN_INC_PATH = /home/jackchuang/share/popcorn-kernel-lib/include
...
#POP_CFLAGS += -ggdb
POP_CFLAGS += -I$(POPCORN_INC_PATH)
POP_CFLAGS += -Wno-unused-function
#POP_CFLAGS += -DCONFIG_POPCORN_HYPE
#POP_CFLAGS += -DCONFIG_POPCORN_USR_DEBUG
#c_flags += $(CFLAGS)
...
$(PROGRAM_ALIAS): $(PROGRAM)
	...
	$(Q) ln -f $(PROGRAM) $@
	execstack -q $(PROGRAM)
	execstack -c $(PROGRAM) ### IMPORTANT
	execstack -q $(PROGRAM)
	echo "test objdump -dSlr lkvm > lkvm.asm"
