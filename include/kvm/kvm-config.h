...
struct kvm_config {
	...
	int debug_iodelay;
	int nrcpus;
	int nodes[MAX_POPCORN_NODES]; // Jack: TODO change to MAX_CPU MAX_POPCORN_NODES
	int total_nodes; /* User input nodes */

	/* From usr */
	const char *kernel_cmdline; /* Auto generated by lvkm arg */
	...
	const char *real_cmdline; /* TODO Jack arch kernel_cmdline + usr specified*/
