...
/* pophype: sync with kernel arch/x86/include/uapi/asm/signal.h
...
void kvm__pause_pophype_migrate_back(struct kvm *kvm); // remotes to origin
void kvm__pause_pophype_migrate(struct kvm *kvm, int op); // origin to remotes
//#endif
